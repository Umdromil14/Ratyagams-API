...
INSERT INTO platform (code, description, abbreviation) VALUES ('XSX', 'Xbox Series X', 'Xbox Series X');

-- Plateforme 4 : Nintendo Switch
INSERT INTO platform (code, description, abbreviation) VALUES ('NSW', 'Nintendo Switch', 'Switch');

-- Plateforme 5 : PlayStation 4
INSERT INTO platform (code, description, abbreviation) VALUES ('PS4', 'PlayStation 4', 'PS4');
...
INSERT INTO platform (code, description, abbreviation) VALUES ('PS3', 'PlayStation 3', 'PS3');

-- Plateforme 10 : Xbox 360
INSERT INTO platform (code, description, abbreviation) VALUES ('X360', 'Xbox 360', 'Xbox 360');

-- Plateforme 11 : PlayStation 2
INSERT INTO platform (code, description, abbreviation) VALUES ('PS2', 'PlayStation 2', 'PS2');

-- Plateforme 12 : Xbox
INSERT INTO platform (code, description, abbreviation) VALUES ('XB', 'Xbox', 'Xbox');

-- Plateforme 14 : Wii
INSERT INTO platform (code, description, abbreviation) VALUES ('WII', 'Wii', 'Wii');

-- Plateforme 15 : Wii U
INSERT INTO platform (code, description, abbreviation) VALUES ('WIIU', 'Wii U', 'Wii U');

-- Plateforme 16 : PlayStation Vita
INSERT INTO platform (code, description, abbreviation) VALUES ('PSV', 'PlayStation Vita', 'PS Vita');

-- Plateforme 17 : PSP (PlayStation Portable)
INSERT INTO platform (code, description, abbreviation) VALUES ('PSP', 'PSP (PlayStation Portable)', 'PSP');

-- Plateforme 18 : Nintendo DS
INSERT INTO platform (code, description, abbreviation) VALUES ('NDS', 'Nintendo DS', 'DS');

-- Plateforme 31 : PS1
INSERT INTO platform (code, description, abbreviation) VALUES ('PS1', 'PlayStation 1', 'PS1');

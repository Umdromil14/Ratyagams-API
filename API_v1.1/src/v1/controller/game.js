 ...
 */
async function createGame(game, res) {
    try {
 ...
 *                          - publication_id
 */
module.exports.createGameFromAdmin = async (req, res) => {
    await createGame(req.body, res);
};
 ...
 *                          - publication_id
 */
module.exports.createGameFromUser = async (req, res) => {
    await createGame({ ...req.body, user_id: req.session.id }, res);
};

...
CREATE TABLE publication (
    ...
    FOREIGN KEY (platform_code) REFERENCES platform(code) ON UPDATE CASCADE,
...
INSERT INTO
    video_game ("name", description)
VALUES
    ('skerhS', 'efil si kerhS, evol si kerhS');
...
VALUES
    ...
    ('Doom 3', 'Rip and tear until it is done'),
    ('Doom 64', 'Rip and tear until it is done'),
    ('Doom', 'Rip and tear until it is done'),
    ('Mighty Doom', 'Rip and tear until it is done');

INSERT INTO
    video_game ("name", description)
VALUES
    ('Portal Revolution', 'The cake is a lie');
...
-- 103. Shrek | wikipedia: https://en.wikipedia.org/wiki/Shrek_(video_game)
INSERT INTO
    publication (
        platform_code,
        video_game_id,
...
VALUES
    ('XB', 104, '2002-03-27', null, null);

-- 105. Doom | wikipedia: https://en.wikipedia.org/wiki/Doom_(1993_video_game)
INSERT INTO
    publication (
        platform_code,
        video_game_id,
...
VALUES
    ...
    ('PS1', 105, '1995-11-16', 4.99, null),
    ('X360', 105, '2006-09-27', 4.99, null),
    ('PS3', 105, '2012-11-20', 4.99, null),
    ('PS4', 105, '2019-07-26', 4.99, null),
    ('XBO', 105, '2019-07-26', 4.99, null),
    (
        'MOB',
        105,
        '2019-07-26',
        4.99,
        'https://play.google.com/store/apps/details?id=com.bethsoft.DOOM&hl=en_US&gl=US'
    ),
    (
        'NSW',
        105,
        '2019-07-26',
        4.99,
        'https://www.nintendo.com/us/store/products/doom-1993-switch/'
    );

-- 106. Doom II | wikipedia: https://en.wikipedia.org/wiki/Doom_II
INSERT INTO
    publication (
        platform_code,
        video_game_id,
...
VALUES
    ...
    ('PS1', 106, '1995-11-16', 4.99, null),
    ('X360', 106, '2010-05-26', 4.99, null),
    ('PS3', 106, '2012-11-20', 4.99, null),
    ('PS4', 106, '2019-07-26', 4.99, null),
    ('XBO', 106, '2019-07-26', 4.99, null),
    (
        'MOB',
        106,
        '2019-07-26',
    ...
    (
        ...
        '2019-07-26',
        4.99,
        'https://www.nintendo.com/us/store/products/doom-ii-classic-switch/'
    );

-- 107. Doom 3 | wikipedia: https://en.wikipedia.org/wiki/Doom_3
INSERT INTO
    publication (
        platform_code,
        video_game_id,
...
VALUES
    ('PC', 107, '2004-08-13', 4.99, null),
    ('XB', 107, '2005-04-08', 4.99, null);

-- 108. Doom 64 | wikipedia: https://en.wikipedia.org/wiki/Doom_64
INSERT INTO
    publication (
        platform_code,
        video_game_id,
...
VALUES
    (
        ...
        '2020-03-20',
        4.99,
        'https://www.nintendo.com/games/detail/doom-64-switch/'
    ),
    (
        'PC',
        108,
    ...
    ('PS4', 108, '2020-03-20', 4.99, null),
    ('XBO', 108, '2020-03-20', 4.99, null);

-- 109. Doom | wikipedia: https://en.wikipedia.org/wiki/Doom_(2016_video_game)
INSERT INTO
    publication (
        platform_code,
        video_game_id,
...
VALUES
    ...
    (
        ...
        '2016-05-13',
        59.99,
        'https://www.playstation.com/en-us/games/doom-ps4/'
    ),
    (
        'XBO',
        109,
        '2016-05-13',
        59.99,
        'https://www.xbox.com/en-us/games/store/doom/c3qh42wrgm3r'
    ),
    (
        'NSW',
        109,
...
-- 110. Mighty Doom | wikipedia: https://en.wikipedia.org/wiki/Mighty_Doom
INSERT INTO
    publication (
        platform_code,
        video_game_id,
...
VALUES
    (
        ...
        '2023-03-21',
        0,
        'https://play.google.com/store/search?q=mighty+doom&c=apps&hl=en_US&gl=US'
    );

-- 110. Portal Revolution | wikipedia: https://en.wikipedia.org/wiki/Portal_Revolution
INSERT INTO
    publication (
        platform_code,
        video_game_id,
...
VALUES ('PC', 111, '2024-01-05', 0, null);
...
VALUES
    (3, 381, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 382, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 383, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 384, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 385, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 386, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 387, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 388, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 389, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 390, TRUE, 5, 'Great game!', '2021-01-01');
...
VALUES
    (3, 391, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 392, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 393, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 394, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 395, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 396, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 397, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 398, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 399, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 400, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 401, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 402, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 403, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 404, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 405, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 406, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 407, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 408, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 409, TRUE, 5, 'Great game!', '2021-01-01'),
    (3, 410, TRUE, 5, 'Great game!', '2021-01-01');
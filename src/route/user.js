...
router.delete('/:userId',Identification.identification,Autorisation.autorization,UserController.deleteUserAdmin);
router.patch('/:userId',Identification.identification,Autorisation.autorization ,UserController.updateUserAdmin);

...
const { gameToGetSchema } = require("../schema/game");
 ...
 * 
 * @param {string} userIdText the id of the user
 * @param {Response} res
 * 
 * @returns {Promise<void>}
 */
async function getGame(userIdText, publicationIdText, res) {
    const result = gameToGetSchema.safeParse({ userId: userIdText, publicationId: publicationIdText });
    if (!result.success) {
    ...
    const { userId, publicationId } = result.data;
